...
const ParticipacionesNacionalesPage = () => {
  ...
  const getResultadoBadge = (resultado: string, destacado: boolean) => {
    if (destacado) {
      return <Badge className="bg-yellow-500">Destacado</Badge>
    }
          ...
          <TabsContent value="historial" className="mt-6">
            <div className="space-y-4">
              {participaciones.map((participacion, index) => (
                <Card
                  key={index}
                  className={`${participacion.destacado ? "border-yellow-500 bg-yellow-50" : ""} hover:shadow-lg transition-shadow`}
                >
                  <CardContent className="p-6">
                ...
                <Card key={index} className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-yellow-500">{jugador.año}</Badge>
                    </div>
                  </CardHeader>
                  <CardContent>
...
export default ParticipacionesNacionalesPage
