...
export default function EntrenadoresPage() {
  const entrenadoresMasculino = [
    ...
    },
    {
      ...
      foto: "/placeholder.svg?height=150&width=150",
      club: "Club Los Leones",
      experiencia: "6 años",
      licencia: "Nivel B",
      telefono: "317 222 0404",
      email: "roberto.silva@email.com",
      logros: ["Subcampeón Liga 2023"],
    },
  ]
  ...
  const entrenadoresFemenino = [
    ...
    },
    {
      ...
      nombre: "Carmen López",
      foto: "/placeholder.svg?height=150&width=150",
      club: "Club Itagüí Femenino",
      experiencia: "9 años",
      licencia: "Nivel A",
      telefono: "320 999 0707",
      email: "carmen.lopez@email.com",
      logros: ["Campeona Copa Femenina 2022", "Entrenadora del Año 2021"],
    },
  ]

  const getLicenciaBadge = (licencia: string) => {
    return licencia === "Nivel A" ? (
      <Badge className="bg-gold-500">Nivel A</Badge>
    ) : (
